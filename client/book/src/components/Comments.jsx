...
const Comments = () => {
    ...
    const response = await axiosInstance.post(`https://neowriters.onrender.com/api/books/${id}/comment`, {text: comment}, {
        headers: {
    ...
    const getAll = async () => {
        const response = await axiosInstance.get(`https://neowriters.onrender.com/api/books/${id}/comment/all`);
 ...
 const handleDelete =async (id) => {
    await axiosInstance.delete(`https://neowriters.onrender.com/api/books/${id}/comment/del`);
 ...
 const handleUpdate = async (id) => {
  await axiosInstance.put(`https://neowriters.onrender.com/api/books/${id}/comment/update`, {text: updatedText});
